      ...
      >
        <div>
          <h1 className='hero-title hero-title-font'>
            Be your <span className='blue-config uppercase'>best</span>
          </h1>
          <h1 className='hero-title hero-title-font'>
            Standout from the{' '}
            <span className='blue-config uppercase'>rest</span>.
          </h1>
        </div>
        <div>
          <p className='py-6 hero-subtitle'>
            Browse our latest collection of items to achive your full potential.
          </p>
        </div>
